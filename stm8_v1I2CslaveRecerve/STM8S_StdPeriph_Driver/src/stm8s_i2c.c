...
/**
  ...
  *     @arg I2C_FLAG_ADDRESSSENTMATCHED: Address sent flag (Master mode) “ADSL?  *   Address matched flag (Slave mode)”ENDAD?  *     @arg I2C_FLAG_STARTDETECTION: Start bit flag (Master mode)
...
/**
  ...
  *               - I2C_ITPENDINGBIT_ADDRESSSENTMATCHED: Address sent flag (Master mode) “ADSL?  *                              Address matched flag (Slave mode)“ENDAD?  *               - I2C_ITPENDINGBIT_STARTDETECTION: Start bit flag (Master mode)
